           ...
           Response body should be like;
{
   ...
   "additionalneeds": "midnight snack"
    ...
    public void get06() {
        //Set the URL
        spec.pathParams("first","booking","second",23);//iki parametrem var isimlerini yaziyoruz.
...
//                );
        ...
        //2. Yol: JsonPath ile
        JsonPath jsonPath = response.jsonPath();//api dan geliyor cunku ben response dan aliyorum response'da da url var.
...
//        assertEquals("Breakfast",jsonPath.getString("additionalneeds"));
        ...
        softAssert.assertEquals(jsonPath.getString("additionalneeds"), "Extra pillows please", "additionalneeds uyuşmadı");
